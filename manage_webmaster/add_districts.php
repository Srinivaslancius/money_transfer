   ...
   <!--  <script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
    ...
    <div class="content-wrapper">
        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Tambahkan Distrik</h6>
                    
                </div>
                <!-- /.page-title-left -->
                <div class="page-title-right d-none d-sm-inline-flex">
                    
                    <div class="d-none d-md-inline-flex justify-center align-items-center"><a href="view_districts.php" class="btn btn-color-scheme btn-sm fs-11 fw-400 mr-l-40 pd-lr-10 mr-l-0-rtl mr-r-40-rtl hidden-xs hidden-sm ripple">Lihat Distrik
</a>
                    </div>
                </div>
                <!-- /.page-title-right -->
        ...
        if (!isset($_POST['submit']))  {
            ...
            $sql = "INSERT INTO lkp_districts (`district_name`,  `lkp_status_id`) VALUES ('$district_name','$lkp_status_id')";
            
            
            $result = $conn->query($sql);
           
            if( $result == 1){
                echo "<script type='text/javascript'>window.location='view_districts.php?msg=success'</script>";
            } else {
                echo "<script type='text/javascript'>window.location='view_districts.php?msg=fail'</script>";
            }
        }
        ?>
                    ...
                    <div class="col-md-6 widget-holder">
                        <div>
                            <div class="widget-body clearfix">
                                <h5 class="box-title mr-b-0">Tambahkan Distrik</h5>
                                <p class="text-muted"></p>
                                <form method="post">
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="l0">Nama kabupaten</label>
                                        <div class="col-md-9">
                                            <input class="form-control" id="l0" placeholder="Masukkan nama kabupaten" type="text" required name="district_name">
                                        </div>
                                    </div>
