        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Add Districts</h6>
                    ...
                    <div class="col-md-6 widget-holder">
                        <div>
                            <div class="widget-body clearfix">
                                <h5 class="box-title mr-b-0">Add Districts</h5>
                                <p class="text-muted"></p>
                                <form method="post">
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="l0">District Name</label>
                                        <div class="col-md-9">
                                            <input class="form-control" id="l0" placeholder="Enter District Name" type="text" required name="district_name">
                                        </div>
                                    </div>
