   ...
   <!--  <script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
    ...
    <div class="content-wrapper">
        ...
        if (!isset($_POST['submit']))  {
            ...
            $sql = "UPDATE `lkp_districts` SET district_name = '$district_name', lkp_status_id = '$lkp_status_id' WHERE id = '$id' ";
        ...
        ?>
        <?php $getDistrictData = getIndividualDetails('lkp_districts','id',$id);
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <?php while($row = $getStatus->fetch_assoc()) {  ?>
                                              <option <?php if($row['id'] == $getDistrictData['lkp_status_id']) { echo "Selected"; } ?> value="<?php echo $row['id']; ?>"><?php echo $row['status']; ?></option>
                                          <?php } ?>
                                            </select>
                                        </div>
                                    </div>
