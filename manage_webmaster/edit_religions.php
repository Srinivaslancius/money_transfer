   ...
   <!--  <script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
    ...
    <div class="content-wrapper">
        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Edit Religions</h6>
                    
                </div>
                <!-- /.page-title-left -->
                <div class="page-title-right d-none d-sm-inline-flex">
                    
                    <div class="d-none d-md-inline-flex justify-center align-items-center"><a href="view_districts.php" class="btn btn-color-scheme btn-sm fs-11 fw-400 mr-l-40 pd-lr-10 mr-l-0-rtl mr-r-40-rtl hidden-xs hidden-sm ripple">View Religions</a>
                    </div>
                </div>
                <!-- /.page-title-right -->
            </div>
        ...
        if (!isset($_POST['submit']))  {
            ...
            $religion_name = $_REQUEST['religion_name'];
            $lkp_status_id = $_REQUEST['lkp_status_id'];

            $sql = "UPDATE `lkp_religion` SET religion_name = '$religion_name', lkp_status_id = '$lkp_status_id' WHERE id = '$id' ";
            $result = $conn->query($sql);           
            if( $result == 1){
                echo "<script type='text/javascript'>window.location='view_religion.php?msg=success'</script>";
            } else {
                echo "<script type='text/javascript'>window.location='view_religion.php?msg=fail'</script>";
            }
        }
        ?>
        <?php $getReligionData = getIndividualDetails('lkp_religion','id',$id);
                    ...
                    <div class="col-md-6 widget-holder">
                        <div>
                            <div class="widget-body clearfix">
                                <h5 class="box-title mr-b-0">Edit Religions</h5>
                                <p class="text-muted"></p>
                                <form method="post">
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="l0">Religion Name</label>
                                        <div class="col-md-9">
                                            <input class="form-control" id="l0" type="text" required name="religion_name" value="<?php echo $getReligionData['religion_name']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <?php while($row = $getStatus->fetch_assoc()) {  ?>
                                              <option <?php if($row['id'] == $getReligionData['lkp_status_id']) { echo "Selected"; } ?> value="<?php echo $row['id']; ?>"><?php echo $row['status']; ?></option>
                                          <?php } ?>
                                            </select>
                                        </div>
                                    </div>
