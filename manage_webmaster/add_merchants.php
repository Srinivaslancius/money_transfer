        ...
        <main class="main-wrapper clearfix">
            ...
            if (!isset($_POST['submit']))  {
              //echo "fail";
                ...
                $saveQrcodeData = "INSERT INTO `merchants`(`business_name`,`merchant_id`, `merchant_full_name`, `merchant_email`, `merchant_mobile`, `login_count`, `last_login_visit`, `created_at`, `merchant_password`, `birth_place`, `dob`, `gender`, `address`, `rt/rw`, `ex/village`, `lkp_district_id`, `lkp_religion_id`, `martial_status`, `work`, `nik`, `merchant_image`,`valid_until`,`auth_key`) VALUES ('".$_REQUEST["business_name"]."','$merchant_id','".$_REQUEST["user_full_name"]."','".$_REQUEST["user_email"]."','".$_REQUEST["user_mobile"]."','1','1','$created_at','".encryptPassword($_REQUEST["user_mobile"])."','".$_REQUEST["birth_place"]."','".$dob."','".$_REQUEST["gender"]."','".$_REQUEST["address"]."','".$_REQUEST["rt/rw"]."','".$_REQUEST["ex/village"]."','".$_REQUEST["lkp_district_id"]."','".$_REQUEST["lkp_religion_id"]."','".$_REQUEST["martial_status"]."','".$_REQUEST["work"]."','".$_REQUEST["data"]."','$merchant_image','".$_REQUEST["valid_until"]."','$generateAuthKey')";
